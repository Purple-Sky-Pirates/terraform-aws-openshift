...
registerhosts:
	...
	envsubst < prepare-hosts-from-bastion.sh | ssh -o StrictHostKeyChecking=no -A ec2-user@$$(terraform output bastion-public_ip)
...
lint:
	terraform get
	TF_VAR_region="eu-west-2" tflint --error-with-issues
